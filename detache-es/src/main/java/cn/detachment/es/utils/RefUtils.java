...
import cn.detachment.es.exception.ParserBaseBeanException;
...
public class RefUtils {
    ...
    public static <T> String getFiledName(FiledFunction<T, ?> filedFunction) {
        ...
        if (prefix == null) {
            throw new ParserBaseBeanException("Invalid Get Method Name <" + methodName + "> must start with is or get");
        }
